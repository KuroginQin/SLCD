...
%Function to compute the generalized F-score and Jaccard simlarity metric
%Given the overlapping community detection result and ground-truth
%gnd_path: path of the ground-truth
%res_path: path of the (overlapping) community detection result
